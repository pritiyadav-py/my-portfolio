...
function ContactLink({ icon, text, link }) {
  return (
    <a
      ...
      className="inline-flex items-center gap-3 text-lg text-accent/80 hover:text-accent font-medium transition-transform transform hover:scale-105"
    >
...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-14 text-center space-y-4" data-aos="fade-up">
        ...
        <div className="pt-4">
            <a
              ...
              download
              className="inline-flex items-center gap-3 bg-accent hover:bg-accent/80 text-white px-6 py-3 rounded-full text-md shadow-lg transition-transform transform hover:scale-105"
            >
              <FaDownload />
              Download My Resume
            </a>
